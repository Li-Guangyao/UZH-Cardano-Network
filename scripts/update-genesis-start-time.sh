...
cp files/byron-genesis.json $CNODE_HOME/files/byron-genesis.json
cp files/shelley-genesis.json $CNODE_HOME/files/shelley-genesis.json
cp files/alonzo-genesis.json $CNODE_HOME/files/alonzo-genesis.json
cp files/conway-genesis.json $CNODE_HOME/files/conway-genesis.json
cp files/config.json $CNODE_HOME/files/config.json
cp files/db-sync-config.json $CNODE_HOME/files/db-sync-config.json:
cp files/topology.json $CNODE_HOME/files/topology.json
